        ...
        <div className="flex items-center justify-between flex-wrap">
          <div className="flex flex-col gap-1">
            ...
            <input type="number" placeholder="0"
              ...
              onChange={e => setCoursePrice(e.target.value)} value={coursePrice} required />
          </div>
          <div className="flex md:flex-row flex-col items-center gap-3">
            <p>Course Thumbnail</p>
            <label htmlFor="thumbnailImage" className="flex items-center gap-3">
              <img src={assets.file_upload_icon} alt="file upload" className="p-3 bg-blue-500 rounded" />
              <input type="file" placeholder="add files" id="thumbnailImage" onChange={e => setImage(e.target.files[0])}
                accept="image/*" hidden />
              <img src={image ? URL.createObjectURL(image) : ""} alt="image" className="max-h-10" />
            </label>
          </div>
        </div>
        <div className="flex flex-col gap-1">
          <p>Discount %</p>
          <input type="number" placeholder="0" min={0} max={100} value={discount}
            ...
            <div className="fixed inset-0 bg-gray-800 bg-opacity-50 flex items-center justify-center">
              ...
              <div className="mb-2">
                ...
                <div className="flex gap-2 my-4">
                  ...
                  className="absolute top-4 right-4 w-4 cursor-pointer" onClick={()=>setShowPopup(false)} />
              </div>
            </div>
          )}
        </div>
