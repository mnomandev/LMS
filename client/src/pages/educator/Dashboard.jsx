     ...
     gap-8 md:p-8 md:pb-0 p-4 pt-8 pb-0'>
      <div className='space-y-5'>
       <div className='flex flex-wrap gap-5 items-center'>
        ...
        shadow-card border border-blue-500 p-4 w-56 rounded-md'>
       <img src={assets.patients_icon } alt="appointment icon"  className="w-10 h-10 object-contain"/>
       <div>
       ...
       <div>
        <p className='text-2xl font-medium
         text-gray-600'>{currency}{dashboardData.totalEarnings}</p>
     ...
     <div>
      ...
      <tbody className='text-sm text-gray-500'>
       ...
       <td className='md:px-4 px-2 py-3 flex items-center space-x-3'>
        <img src={item.student.imageUrl} alt="student profile" className='w-9 h-9 rounded-full'/>
