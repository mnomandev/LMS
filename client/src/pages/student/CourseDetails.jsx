...
const CourseDetail = () => {
  ...
  const { allCourses, calculateRating, calculateChapterTime, calculateCourseDuration, calculateTotalLectures, currency } = useContext(AppContext);
  ...
  return courseData ? (
    <>
      <div className="min-h-screen flex flex-col">
        ...
        <div className="flex-1 flex md:flex-row flex-col-reverse gap-10
        relative items-start justify-between md:px-36 px-8 md:pt-25 pt-15
        text-left bg-gradient-to-b from-cyan-200/70">
              ...
              <div className="pt-5">
                {courseData.courseContent.map((chapter, index) => (
                  <div key={index} className="border border-gray-300 bg-white mb-2 rounded">
                    ...
                    <div className={`overflow-hidden transition-all duration-3000 ${openSections[index] ? "max-h-96" : "max-h-0"}`}>
                      <ul className="list-disc md:pl-10 pl-4 pr-4 py-2
          ...
          {/* Right Column */}
          <div className="max-w-[424px] shadow-[0px_4px_15px_2px_rgba(0,0,0,0.1)] rounded-t md:rounded-none
            ...
            <div className="p-5">
              ...
              <div className="pt-6 ">
                <p className="md:text-xl text-lg font-medium text-gray-800">What's in the courses?</p>
